...
urlpatterns = [
    ...
    path('', include('emailconfig.urls', namespace='emailconfig')),
    path('product/', include('product.urls', namespace='products')),
    path('order/', include('order.urls', namespace='order')),
    path('', include('dashboard.urls', namespace='dashboard')),

    path('forgot/password/reset/', auth_views.PasswordResetView.as_view(template_name='registration/forgot_password.html'), name='password_reset'),
